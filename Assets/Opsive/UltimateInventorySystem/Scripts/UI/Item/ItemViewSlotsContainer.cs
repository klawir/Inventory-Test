...
namespace Opsive.UltimateInventorySystem.UI.Item
{
    ...
    public class ItemViewSlotsContainer : ItemViewSlotsContainerBase
    {
        ...
        /// <summary>
        /// Initialize the view slots and assign them to the view drawer.
        /// </summary>
        /// <param name="force">Fore initialize?</param>
        public virtual void InitializeViewSlots(bool force)
        {
            if (m_IsInitialized && !force) {
                return;
            }
