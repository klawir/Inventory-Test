...
namespace Opsive.UltimateInventorySystem.UI
{
    ...
    public class TabControl : MonoBehaviour, ITabControl
    {
        ...
        [Tooltip("Should the tabs loop. previous on first goes to last.")]
        [SerializeField] protected bool m_LoopNavigation;
        ...
        public bool NextTab()
        {
            ...
            if (m_TabIndex + 1 < m_TabToggles.Length) {
        ...
        public bool PreviousTab()
        {
            ...
            if (m_TabIndex > 0) {
                ...
                SetTabOn( m_TabToggles.Length-1);
            }
        ...
        {
            if (m_PreviousButton != null) {
                m_PreviousButton.gameObject.SetActive(m_LoopNavigation || m_TabIndex != 0);
            }

            if (m_NextButton != null) {
                m_NextButton.gameObject.SetActive(m_LoopNavigation || m_TabIndex != TabCount - 1);
            }
        }
    }
}