...
namespace Opsive.UltimateInventorySystem.Core.InventoryCollections
{
    ...
    public class Inventory : MonoBehaviour, IInventory, IDatabaseSwitcher
    {
        ...
        public virtual float GetFloatSum(string attributeName, bool perAmount= false)
        {
            return AttributeUtility.GetFloatSum(attributeName, (ListSlice<ItemInfo>)m_CachedItemInfos, perAmount);
        }
        ...
        /// /// <param name="perAmount"> multiply the sum by the item amount in each slot.</param>
        /// <returns>Returns the sum of the attribute values with the attribute name.</returns>
        public virtual int GetIntSum(string attributeName, bool perAmount = false)
        {
            return AttributeUtility.GetIntSum(attributeName, (ListSlice<ItemInfo>)m_CachedItemInfos, perAmount);
        }
