...
namespace Opsive.Shared.Input
{
        ...
        IPlayerInput
    {
        ...
        private ScheduledEventBase m_FocusEvent;
        ...
        protected virtual void Awake()
        {
            ...
            // Prevent the input from being received until after the specified number of frames.
            if (m_FrameWaitCount > 0) {
                m_Focus = false;
                FrameCheck();
            }
        }
        ...
        /// <summary>
        /// Registers for the events on the specified GameObject.
        /// </summary>
        /// <param name="targetGameObject">The target character.</param>
        public void RegisterEvents(GameObject targetGameObject)
        {
            m_GameObject = targetGameObject;

            EventHandler.RegisterEvent<float>(m_GameObject, "OnCharacterChangeTimeScale", ChangeTimeScale);
            EventHandler.RegisterEvent<bool>(m_GameObject, "OnEnableGameplayInput", EnableGameplayInput);
            EventHandler.RegisterEvent<Vector3, Vector3, GameObject>(m_GameObject, "OnDeath", OnDeath);
            EventHandler.RegisterEvent(m_GameObject, "OnRespawn", OnRespawn);
        }

        /// <summary>
        /// Refocuses the component after the specified number of frames. When Unity is loading it will buffer all of the input during the load.
        /// This will unintentionally rotate the camera. Prevent this from happening by setting the focus.
        /// </summary>
        ...
        private void OnDestroy()
        {
            ...
            EventHandler.UnregisterEvent<float>(m_GameObject, "OnCharacterChangeTimeScale", ChangeTimeScale);
            EventHandler.UnregisterEvent<bool>(m_GameObject, "OnEnableGameplayInput", EnableGameplayInput);
